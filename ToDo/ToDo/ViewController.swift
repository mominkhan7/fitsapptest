...
//  ToDo
//
//  Created by Momin Khan on 12/20/16.
//  Copyright © 2016 Momin Khan. All rights reserved.
//
...
class ViewController: UITableViewController {
   ...
   func setupRealm() {
      ...
      let username = "mkhanboy@gmail.com"  // <--- Update this
      let password = "fitsapptest"  // <--- Update this
